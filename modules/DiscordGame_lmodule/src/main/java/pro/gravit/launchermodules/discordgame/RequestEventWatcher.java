...
public class RequestEventWatcher implements RequestService.EventHandler {
    ...
    public <T extends WebSocketEvent> boolean eventHandle(T event) {
        if (event instanceof AuthRequestEvent authEvent && authEvent.playerProfile != null) {
            DiscordBridge.activityService.updateAuthorizedStage(authEvent.playerProfile);
        }
